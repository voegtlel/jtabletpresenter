...
public class DocumentEditorClientFull implements IDocumentEditor {
	...
	public DocumentEditorClientFull() {
	...
	public DocumentEditorClientFull(final BinaryDeserializer reader) throws IOException {
		reader.resetState();
